...
import { JSONRPCErrorResponse, MessageSendParams, TaskQueryParams, TaskIdParams, TaskPushNotificationConfig, A2ARequest } from "../types.js";
import { A2AError } from "../server/error.js";
import { MomentoAgentRequestHandler } from "../agent/request_handler.js";

/**
 * Handles JSON-RPC transport layer, routing requests to MomentoAgentRequestHandler.
 */
export class JsonRpcTransportHandler {
  private requestHandler: MomentoAgentRequestHandler;

  constructor(requestHandler: MomentoAgentRequestHandler) {
   ...
   */
  public async handle(requestBody: any): Promise<A2AResponse | AsyncGenerator<A2AResponse, void, undefined>> {
